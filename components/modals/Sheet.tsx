    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 z-[1005] transition-all duration-&lsqb;350ms&rsqb; ease-in-out cursor-pointer ">
          ...
          <div
            ref={modalRef}
            className="p-3 px-8 py-10 md:py-1 md:pb-10 z-50 md:w-[50%] lg:w-[40%] xl:w-[36%] overflow-y-auto h-full relative bg-white ml-auto  scrollbar-hide dark:bg-background"
          >
            {children}
          </div>
        </div>
